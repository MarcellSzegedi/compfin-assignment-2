"""Command to plot the strong convergence order difference between euler and milstein schemes."""
...
from compfin_assignment_2.asian_option.heston_model.benchmarks import (
    strong_convergence_calculation_vanilla_option,
)
...
def scheme_comp_strong_vanilla(
    ...
    for strike_price in tqdm(strike_prices, desc="Strike Prices", leave=False, position=0):
        euler_payoff_diff, milstein_payoff_diff = strong_convergence_calculation_vanilla_option(
    ...
    plot_convergence_order_difference(
        ...
        milstein_results,
        n_time_steps,
        title="Strong Convergence Order Difference",
        file_name="strong_convergence_plot",
    )
